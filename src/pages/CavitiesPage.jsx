...
export const CavitiesPage = () => {
    ...
    return (
        <>
            <Header />
            <main className="container overflow-auto bg-black/50 backdrop-blur-sm w-11/12 md:h-[70vh] lg:w-3/4 lg:p-16 mt-10 mb-72 md:mt-10 md:mb-10 mx-auto rounded-md p-2">
